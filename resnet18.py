# resnet18
from keras.layers import Input, Conv2D, BatchNormalization, MaxPooling2D, ReLU, add, GlobalAveragePooling2D, Dense
from keras.models import Model


def resnet18(input_shape=(224,224,3), width=64, n_classes=100, notop=False):
    ...
    if notop:
        ...
        x = Dense(n_classes, use_bias=True)(x)
        model = Model(inpt, feats+[x])
...
if __name__ == '__main__':
    ...
    # model.summary()
    # model.load_weights("convert/r18_notop.h5")
