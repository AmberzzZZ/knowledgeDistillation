# model_teacher: resnet back + bifpn + dense head
...
def modelT(input_shape=(512,512,3), n_classes=100, bifpn_repeats=1):

    inpt = Input(input_shape)

    # resnet back
    outs = resnet18(input_shape, width=64, n_classes=n_classes, notop=True)(inpt)
    s_feats = outs[:4]
    ...
    t_output = Dense(n_classes, use_bias=True, activation='softmax')(x)

    # model
    model = Model(inpt, t_output)
